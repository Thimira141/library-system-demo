import{j as a}from"./jquery.module-gzd0YkcT.js";import"./responsive.bootstrap5-D_HSXjOo.js";a(document).ready(function(){a("#membersTable").DataTable({processing:!0,serverSide:!0,searching:!1,ajax:{url:"/members/data",type:"POST",headers:{"X-CSRF-TOKEN":a('meta[name="csrf-token"]').attr("content")},data:function(e){e.search={value:a("#searchBox").val()}}},columns:[{data:"member_name",orderable:!0,searchable:!0,render:function(e,r,t){return r==="sort"||r==="filter"?e:`<div class="d-md-inline-block d-sm-flex">
