        ...
        <div class="col">
            <ul class="nav nav-tabs nav-pills mb-3" id="myTab" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link " id="main-dashboard-tab" data-bs-toggle="tab"
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="borrow-return-tab" data-bs-toggle="tab"
            ...
            <div class="tab-content p-2" id="myTabContent">
                <div class="tab-pane fade " id="main-dashboard-tab-pane" role="tabpanel"
                    aria-labelledby="main-dashboard-tab" tabindex="0">
                    @include('dashboard.dashboard')
                </div>
                <div class="tab-pane fade show active" id="borrow-return-tab-pane" role="tabpanel" aria-labelledby="borrow-return-tab"
                    tabindex="0">
