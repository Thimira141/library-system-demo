...
@section('content')
    ...
    <div class="container my-2  py-2">
        ...
        {{-- end title section --}}
        {{-- form area --}}
        <form method="post" action="{{ route('books-create-new-book') }}" class="ajax-form" enctype="multipart/form-data">
            @csrf
            @method('POST')
            {{-- 1st row --}}
            <div class="row mx-2 mb-3 bg-body-secondary rounded p-3">
                ...
                <div class="col-lg-2 col-md-3 col-sm-12 p-2 bg-gradient rounded-4 d-flex align-items-center">
                    <div class="w-100 h-auto position-relative cover-image-action-btn-hover-cover">
                        <img src="..." class="img-fluid rounded-top w-100" alt="" id="book_cover_img-preview"
                ...
                <div class="col  ms-md-3 ms-0 p-2">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="book_title" name="book_title" class="form-control" placeholder="" />
                    </div>
                    <div class="mb-3">
                        <label for="book_author" class="form-label">Book Author</label>
                        <input type="text" id="book_author" name="book_author" class="form-control" placeholder="" />
                    </div>
                </div>
            </div>
            {{-- 2nd row --}}
